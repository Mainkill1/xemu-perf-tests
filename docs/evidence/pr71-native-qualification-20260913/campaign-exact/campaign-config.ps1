...
$Campaign = [ordered]@{
    SchemaVersion = 3
    CampaignId = 'pr71-fa009-qualification-20260913'
    PackageRoot = $PSScriptRoot
    ResultsRoot = Join-Path $LabRoot 'captures\pr71-fa009-qualification-20260913'
    ...
    Builds = [ordered]@{
        ...
        candidate = [ordered]@{
            Role = 'candidate'
            LogicalCommit = 'fa00907d08239657e5ec1ec19041df138ab6ae4b'
            SourceCommit = 'fa00907d08239657e5ec1ec19041df138ab6ae4b'
            Tree = '0ee676b3e4b5da8447b322772495fee3847fc703'
            Xemu = Join-Path $IncomingRoot 'pr71-fa009-exact\xemu.exe'
            XemuSha256 = '6e8053816aef10597d7f0f4c597c348c5deada28acafb4247327bc80d137f116'
            BuildInfo = Join-Path $IncomingRoot 'pr71-fa009-exact\BUILD_INFO.txt'
        }
    }
