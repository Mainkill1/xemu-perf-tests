...
try {
    ...
    # The prior PGR2 snapshot diagnostic remains separate evidence.
    $receipt.cells += Invoke-Pgr2Workload 'pgr2_full_start' 'FreshBoot' 1
    $receipt.cells += Invoke-MorrowindWorkload 14
