...
enum class XemuPerfAssertion : uint16_t {
  ...
  PFIFO_BOUNDARY_FRAMEBUFFER = 0x144,
  ...
  REPORT_TIMEOUT_A = 0x160,
  REPORT_TIMEOUT_B = 0x161,
  REPORT_ZERO_VALUE = 0x162,
  REPORT_NONZERO_VALUE = 0x163,
  REPORT_CLEAR_VALUE = 0x164,
  REPORT_CUMULATIVE_VALUE = 0x165,
